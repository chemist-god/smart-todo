                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select
                            ...
                            className="px-3 py-1.5 text-sm font-medium bg-background border border-border rounded-lg focus-enhanced hover:bg-muted transition-colors"
                        >
            ...
            <div className="space-y-4">
                {filteredTodos.length === 0 ? (
                    <div className="bg-card border border-border rounded-xl shadow-soft p-12 text-center">
                        ...
                        {filter === "all" && (
                            <button className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-medium rounded-lg hover:bg-primary/90 transition-all duration-200 shadow-soft hover:shadow-medium focus-enhanced">
