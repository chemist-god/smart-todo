...
export default function ProductivityChart() {
    ...
    const safeData = data ? validateProductivityData(data) : null;
        ...
        return (
            <div className="backdrop-blur-sm bg-card/50 rounded-2xl p-8 border border-border/50 shadow-lg text-center">
                <div className="max-w-md mx-auto">
                    ...
                    <h3 className="text-lg font-semibold text-foreground mb-2">Start Your Productivity Journey</h3>
                    <p className="text-muted-foreground mb-6">
                        Complete some tasks to see your productivity analytics and insights. Every completed task helps you understand your patterns and improve your efficiency.
                    </p>
                    <div className="text-sm text-muted-foreground">
                        💡 <strong>Pro tip:</strong> Set specific deadlines and priorities to get the most accurate analytics.
                    </div>
                </div>
            </div>
        );
